...
class CricelPage extends StatefulWidget {
  @override
  CricelPageState createState() => CricelPageState();
}

class CricelPageState extends State<CricelPage> with AutomaticKeepAliveClientMixin{
  int page = 1;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _getMain(context),
      backgroundColor: Colors.white,
      resizeToAvoidBottomInset:false
    );
  }

  Widget _getMain(BuildContext context){
     if (couponList.length == 0){
      return Container(
        ...
        return  EasyRefresh(
                  ...
                  onLoad: () async{
                    AppNavigator.pushCricelMorePage(context);
                    // page ++;
                    // _couponList(page,"3786");
                  },
