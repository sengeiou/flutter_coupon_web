define(['dart_sdk', 'packages/flutter_web/animation', 'packages/flutter_web_ui/ui', 'packages/flutter_web/src/animation/animation', 'packages/vector_math/vector_math_64'], function(dart_sdk, packages__flutter_web__animation, packages__flutter_web_ui__ui, packages__flutter_web__src__animation__animation, packages__vector_math__vector_math_64) {
  ...
  dart.defineLazy(CT, {
    ...
    get C5() {
      return C5 = dart.const({
        ...
        [_Location_column]: 25,
        [_Location_line]: 57,
        [_Location_file]: "org-dartlang-app:///packages/hkbook/ThridLib/flutter_spinkit-4.1.1+1/lib/src/rotating_plain.dart"
      });
    },
    get C11() {
  ...
  let C0;
  const color$ = dart.privateName(rotating_plain, "SpinKitRotatingPlain.color");
  const size$ = dart.privateName(rotating_plain, "SpinKitRotatingPlain.size");
  const itemBuilder$ = dart.privateName(rotating_plain, "SpinKitRotatingPlain.itemBuilder");
  const duration$ = dart.privateName(rotating_plain, "SpinKitRotatingPlain.duration");
  const controller$ = dart.privateName(rotating_plain, "SpinKitRotatingPlain.controller");
  ...
  (rotating_plain.SpinKitRotatingPlain.new = function(opts) {
    ...
    if (!(!(BuildContextAndintToWidget().is(itemBuilder) && ui.Color.is(color)) && !(itemBuilder == null && color == null))) dart.assertFailed("You should specify either a itemBuilder or a color", "org-dartlang-app:///packages/hkbook/ThridLib/flutter_spinkit-4.1.1+1/lib/src/rotating_plain.dart", 11, 16, "!(itemBuilder is IndexedWidgetBuilder && color is Color) && !(itemBuilder == null && color == null)");
    if (!(size != null)) dart.assertFailed(null, "org-dartlang-app:///packages/hkbook/ThridLib/flutter_spinkit-4.1.1+1/lib/src/rotating_plain.dart", 13, 16, "size != null");
  ...
  dart.setLibraryUri(rotating_plain.SpinKitRotatingPlain, "package:hkbook/ThridLib/flutter_spinkit-4.1.1+1/lib/src/rotating_plain.dart");
  ...
  const _controller = dart.privateName(rotating_plain, "_controller");
  ...
  let C4;
  let C3;
  const _itemBuilder = dart.privateName(rotating_plain, "_itemBuilder");
  ...
  let C18;
  let C17;
  const State_SingleTickerProviderStateMixin$36 = class State_SingleTickerProviderStateMixin extends framework.State$(rotating_plain.SpinKitRotatingPlain) {};
  ...
  dart.applyMixin(State_SingleTickerProviderStateMixin$36, ticker_provider.SingleTickerProviderStateMixin$(rotating_plain.SpinKitRotatingPlain));
  rotating_plain._SpinKitRotatingPlainState = class _SpinKitRotatingPlainState extends State_SingleTickerProviderStateMixin$36 {
    initState() {
      let t0, t0$;
      super.initState();
    ...
    [_itemBuilder](index) {
      return this.widget.itemBuilder != null ? this.widget.itemBuilder(this.context, index) : new container.DecoratedBox.new({decoration: new box_decoration.BoxDecoration.new({color: this.widget.color}), $creationLocationd_0dea112b090073317d4: C17 || CT.C17});
    }
  };
  ...
  dart.setLibraryUri(rotating_plain._SpinKitRotatingPlainState, "package:hkbook/ThridLib/flutter_spinkit-4.1.1+1/lib/src/rotating_plain.dart");
  ...
  dart.trackLibraries("packages/hkbook/ThridLib/flutter_spinkit-4.1.1+1/lib/src/rotating_plain", {
    "package:hkbook/ThridLib/flutter_spinkit-4.1.1+1/lib/src/rotating_plain.dart": rotating_plain
  }, {
  }, '{"version":3,"sourceRoot":"","sources":["rotating_plain.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAec;;;;;;IACC;;;;;;IACc;;;;;;IACZ;;;;;;IACW;;;;;;;AAGkB;IAA4B;;;QAlBlE;QACC;QACA;QACA;QACA;QACA;;IAJA;IACA;IACA;IACA;IACA;UAC+D,EAA3C,gCAAZ,WAAW,KAAkC,YAAN,KAAK,QAAgB,AAAY,WAAD,IAAI,QAAQ,AAAM,KAAD,IAAI,0BACjG;UACG,AAAK,IAAD,IAAI;AACf,uEAAW,GAAG;;EAAC;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAkBF,MAAX;AAIM,MAFZ,4BAAiC,KAAlB,AAAO,8BAAA,OAAc,yDAA2B,gBAAgB,AAAO,8BAClF,gBAAY,cAAM,cAAS;yCAC3B;AAEqG,MADzG,oBAAc,AACT,kCADsB,UAAU,gBACxB,4CAAwB;AAEqE,MAD1G,oBAAc,AACT,kCADsB,UAAU,gBACxB,4CAAwB;IACvC;;AAIuB,MAArB,AAAY;AACG,MAAT;IACR;UAG0B;;AACxB,YAAO,8BACE,0CACc,mCACf,WAAgC,CAAvB,AAAE,iBAAE,AAAY,4BAAS,YAClC,WAAgC,CAAvB,AAAE,iBAAE,AAAY,4BAAS,4BACV,kDACZ,mCACH,mBAAO,AAAO,0BAClB,mBAAa;IAI5B;mBAEwB;AAAU,YAAA,AAAO,AAAY,4BAAG,OAClD,AAAO,wBAAY,cAAS,KAAK,IACjC,4CAAyB,6CAAqB,AAAO;IAAO;;;IAxC9C;IACF;IAAa;;;EAwCjC","file":"rotating_plain.ddc.js"}');
  // Exports:
  return {
    ThridLib__flutter_spinkit_4$461$461$431__lib__src__rotating_plain: rotating_plain
  };
});

//# sourceMappingURL=rotating_plain.ddc.js.map
