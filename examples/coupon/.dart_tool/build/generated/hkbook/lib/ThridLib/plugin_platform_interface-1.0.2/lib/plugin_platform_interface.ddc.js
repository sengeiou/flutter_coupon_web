define(['dart_sdk'], function(dart_sdk) {
    ...
    static verifyToken(instance, token) {
      if (plugin_platform_interface.MockPlatformInterfaceMixin.is(instance)) {
        ...
        if (!dart.test(dart.fn(() => {
          ...
          return true;
        }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/hkbook/ThridLib/plugin_platform_interface-1.0.2/lib/plugin_platform_interface.dart", 62, 14, "() {\n        assertionsEnabled = true;\n        return true;\n      }()");
  ...
  dart.setLibraryUri(plugin_platform_interface.PlatformInterface, "package:hkbook/ThridLib/plugin_platform_interface-1.0.2/lib/plugin_platform_interface.dart");
  ...
  dart.setLibraryUri(plugin_platform_interface.MockPlatformInterfaceMixin, "package:hkbook/ThridLib/plugin_platform_interface-1.0.2/lib/plugin_platform_interface.dart");
  dart.trackLibraries("packages/hkbook/ThridLib/plugin_platform_interface-1.0.2/lib/plugin_platform_interface", {
    "package:hkbook/ThridLib/plugin_platform_interface-1.0.2/lib/plugin_platform_interface.dart": plugin_platform_interface
  }, {
  }, '{"version":3,"sourceRoot":"","sources":["plugin_platform_interface.dart"],"names":[],"mappings":";;;;;;;;;;uBA0D4C,UAAiB;AACzD,UAAa,wDAAT,QAAQ;AACL,gCAAoB;AACzB,uBAAO,AAGN;AAFyB,UAAxB,oBAAoB;AACpB,gBAAO;;AAET,aAAK,iBAAiB;AAE0D,UAD9E,WAAM,4BACF;;AAEN;;AAEF,0BAAe,KAAK,EAAE,AAAS,QAAD;AAEwC,QADpE,WAAM,4BACF;;IAER;;;QAhCoC;IAAyB,uBAAE,KAAK;;;;;;;;;;;;EAkDE","file":"plugin_platform_interface.ddc.js"}');
  // Exports:
  return {
    ThridLib__plugin_platform_interface_1$460$462__lib__plugin_platform_interface: plugin_platform_interface
  };
});
