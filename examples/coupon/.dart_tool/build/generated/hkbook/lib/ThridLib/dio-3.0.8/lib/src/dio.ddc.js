define(['dart_sdk', 'packages/hkbook/ThridLib/dio-3.0.8/lib/src/adapter', 'packages/hkbook/ThridLib/dio-3.0.8/lib/src/interceptor', 'packages/hkbook/ThridLib/dio-3.0.8/lib/src/headers', 'packages/hkbook/ThridLib/dio-3.0.8/lib/src/redirect_record', 'packages/hkbook/ThridLib/dio-3.0.8/lib/src/form_data', 'packages/hkbook/ThridLib/dio-3.0.8/lib/src/adapters/browser_adapter'], function(dart_sdk, packages__hkbook__ThridLib__dio_3$460$468__lib__src__adapter, packages__hkbook__ThridLib__dio_3$460$468__lib__src__interceptor, packages__hkbook__ThridLib__dio_3$460$468__lib__src__headers, packages__hkbook__ThridLib__dio_3$460$468__lib__src__redirect_record, packages__hkbook__ThridLib__dio_3$460$468__lib__src__form_data, packages__hkbook__ThridLib__dio_3$460$468__lib__src__adapters__browser_adapter) {
  'use strict';
  ...
  const transformer = packages__hkbook__ThridLib__dio_3$460$468__lib__src__adapter.ThridLib__dio_3$460$468__lib__src__transformer;
  ...
  const cancel_token = packages__hkbook__ThridLib__dio_3$460$468__lib__src__adapter.ThridLib__dio_3$460$468__lib__src__cancel_token;
  ...
  const form_data = packages__hkbook__ThridLib__dio_3$460$468__lib__src__form_data.ThridLib__dio_3$460$468__lib__src__form_data;
  const browser_adapter = packages__hkbook__ThridLib__dio_3$460$468__lib__src__adapters__browser_adapter.ThridLib__dio_3$460$468__lib__src__adapters__browser_adapter;
  ...
  let dynamicAndboolToFunction = () => (dynamicAndboolToFunction = dart.constFn(dart.fnType(core.Function, [dart.dynamic, core.bool])))();
  let dynamicToFunction = () => (dynamicToFunction = dart.constFn(dart.fnType(core.Function, [dart.dynamic])))();
  ...
  const options = dart.privateName(dio, "Dio.options");
  const httpClientAdapter = dart.privateName(dio, "Dio.httpClientAdapter");
  const transformer$ = dart.privateName(dio, "Dio.transformer");
  ...
  dart.setLibraryUri(dio.Dio, "package:hkbook/ThridLib/dio-3.0.8/lib/src/dio.dart");
  ...
  const options$0 = dart.privateName(dio, "DioMixin.options");
  const httpClientAdapter$ = dart.privateName(dio, "DioMixin.httpClientAdapter");
  const transformer$0 = dart.privateName(dio, "DioMixin.transformer");
    ...
    [_request](T, path, opts) {
      ...
      return async.async(response$.Response$(T), (function* _request() {
        ...
        this.interceptors[$forEach](dart.fn(interceptor => {
          future = future.then(dart.dynamic, dynamicToFutureOr()._check(_interceptorWrapper(dart.bind(interceptor, 'onRequest'), true)));
        }, InterceptorToNull()));
        future = future.then(dart.dynamic, dynamicToFutureOr()._check(_interceptorWrapper(dart.bind(this, _dispatchRequest), true)));
        this.interceptors[$forEach](dart.fn(interceptor => {
          future = future.then(dart.dynamic, dynamicToFutureOr()._check(_interceptorWrapper(dart.bind(interceptor, 'onResponse'), false)));
        }, InterceptorToNull()));
        this.interceptors[$forEach](dart.fn(interceptor => {
      ...
      return async.async(StreamOfUint8List(), (function* _transformData() {
        ...
        if (data != null && dart.test(JSArrayOfString().of(["POST", "PUT", "PATCH", "DELETE"])[$contains](options.method))) {
          ...
          if (async.Stream.is(data)) {
            if (!StreamOfList().is(data)) dart.assertFailed("Stream type must be `Stream<List>`, but " + dart.str(dart.runtimeType(data)) + " is found.", "org-dartlang-app:///packages/hkbook/ThridLib/dio-3.0.8/lib/src/dio.dart", 992, 16, "data is Stream<List>");
  ...
  (dio.DioMixin.new = function() {
    ...
    this[httpClientAdapter$] = null;
    this[transformer$0] = new transformer.DefaultTransformer.new();
    this[_closed] = false;
    ;
  ...
  dart.setMethodSignature(dio.DioMixin, () => ({
    ...
    checkIfNeedEnqueue: dart.fnType(async.FutureOr, [interceptor.Lock, dart.fnType(async.FutureOr, [])]),
  ...
  dart.setLibraryUri(dio.DioMixin, "package:hkbook/ThridLib/dio-3.0.8/lib/src/dio.dart");
  ...
  (dio_for_browser.DioForBrowser.new = function(options) {
    ...
    this.options = (t2 = options, t2 == null ? new options$.BaseOptions.new() : t2);
