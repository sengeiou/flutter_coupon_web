define(['dart_sdk', 'packages/flutter_web/src/animation/animation'], function(dart_sdk, packages__flutter_web__src__animation__animation) {
  ...
  dart.setLibraryUri(shared_preferences_platform_interface.SharedPreferencesStorePlatform, "package:hkbook/ThridLib/shared_preferences_platform_interface-1.0.1/lib/shared_preferences_platform_interface.dart");
  ...
  dart.setLibraryUri(method_channel_shared_preferences.MethodChannelSharedPreferencesStore, "package:hkbook/ThridLib/shared_preferences_platform_interface-1.0.1/lib/method_channel_shared_preferences.dart");
  let C2;
  ...
  dart.setLibraryUri(shared_preferences_platform_interface.InMemorySharedPreferencesStore, "package:hkbook/ThridLib/shared_preferences_platform_interface-1.0.1/lib/shared_preferences_platform_interface.dart");
  ...
  dart.trackLibraries("packages/hkbook/ThridLib/shared_preferences_platform_interface-1.0.1/lib/method_channel_shared_preferences", {
    "package:hkbook/ThridLib/shared_preferences_platform_interface-1.0.1/lib/method_channel_shared_preferences.dart": method_channel_shared_preferences,
    "package:hkbook/ThridLib/shared_preferences_platform_interface-1.0.1/lib/shared_preferences_platform_interface.dart": shared_preferences_platform_interface
  }, {
  }, '{"version":3,"sourceRoot":"","sources":["shared_preferences_platform_interface.dart","method_channel_shared_preferences.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAqBwD;IAAS;wBAIZ;AACjD,qBAAK,AAAM,KAAD;AACR;AAC+C,UAA7C,AAAM,KAAD;;cACuB;AAA5B;AAEoE,YADpE,WAAM,4BACF;;;;;AAGS,MAAjB,iFAAY,KAAK;IACnB;;AAWmB;IAAK;;IA4BsB;;;;EAChD;;;;;;;;;;;;MAtCwC,8EAAS;YAC3C;;;;;WClBuB;AACzB,YAAO,yBAAkB,UAA2B,0CAClD,OAAO,GAAG;IAEd;aAG6B,WAAkB,KAAY;AACzD,YAAO,yBAAkB,AAAe,iBAAV,SAAS,GAAoB,0CACzD,OAAO,GAAG,EACV,SAAS,KAAK;IAElB;wBAEsC,QAA6B;AACjE,YAAO,AACF,AAOA,qEAPmB,MAAM,EAAE,MAAM,kBAOtB,QAAS,kCAAW,MAAM;IAC5C;;AAIE,YAAO,AAAU,qEAAmB;IACtC;;AAIE,YAAO,AAAU,uFAAgC;IACnD;;;;EACF;;;;;;;;;;;;;;;;;;MA7CoB,2CAAS;;;;;;;ADiFT;AACH,QAAb,AAAM;AACN,cAAO;MACT;;;AAGkC;AAChC,mDAAgC;MAClC;;WAG2B;AAAR;AACA,QAAjB,AAAM,qBAAO,GAAG;AAChB,cAAO;MACT;;aAG6B,WAAkB,KAAY;AAAtC;AACD,QAAlB,AAAK,mBAAC,GAAG,EAAI,KAAK;AAClB,cAAO;MACT;;;;IA7B+C,cAAkB;;EAAE;4FAGP;kBAChD,oCAA2B,IAAI;;EAAC","file":"method_channel_shared_preferences.ddc.js"}');
  // Exports:
  return {
    ThridLib__shared_preferences_platform_interface_1$460$461__lib__method_channel_shared_preferences: method_channel_shared_preferences,
    ThridLib__shared_preferences_platform_interface_1$460$461__lib__shared_preferences_platform_interface: shared_preferences_platform_interface
  };
});
