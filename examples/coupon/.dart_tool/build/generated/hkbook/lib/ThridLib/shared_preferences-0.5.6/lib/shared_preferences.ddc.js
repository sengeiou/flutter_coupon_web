define(['dart_sdk', 'packages/hkbook/ThridLib/shared_preferences_platform_interface-1.0.1/lib/method_channel_shared_preferences'], function(dart_sdk, packages__hkbook__ThridLib__shared_preferences_platform_interface_1$460$461__lib__method_channel_shared_preferences) {
  'use strict';
  ...
  const shared_preferences_platform_interface = packages__hkbook__ThridLib__shared_preferences_platform_interface_1$460$461__lib__method_channel_shared_preferences.ThridLib__shared_preferences_platform_interface_1$460$461__lib__shared_preferences_platform_interface;
  ...
  shared_preferences.SharedPreferences = class SharedPreferences extends core.Object {
    ...
    static _getSharedPreferencesMap() {
      return async.async(MapOfString$Object(), function* _getSharedPreferencesMap() {
        ...
        if (!(fromSystem != null)) dart.assertFailed(null, "org-dartlang-app:///packages/hkbook/ThridLib/shared_preferences-0.5.6/lib/shared_preferences.dart", 168, 12, "fromSystem != null");
        let preferencesMap = new (IdentityMapOfString$Object()).new();
        for (let key of fromSystem[$keys]) {
          if (!key[$startsWith]("flutter.")) dart.assertFailed(null, "org-dartlang-app:///packages/hkbook/ThridLib/shared_preferences-0.5.6/lib/shared_preferences.dart", 172, 14, "key.startsWith(_prefix)");
  ...
  dart.setLibraryUri(shared_preferences.SharedPreferences, "package:hkbook/ThridLib/shared_preferences-0.5.6/lib/shared_preferences.dart");
