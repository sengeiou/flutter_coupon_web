define(['dart_sdk'], function(dart_sdk) {
  ...
  const autoUncompress = dart.privateName(io, "HttpClient.autoUncompress");
  const connectionTimeout = dart.privateName(io, "HttpClient.connectionTimeout");
  const idleTimeout = dart.privateName(io, "HttpClient.idleTimeout");
  const maxConnectionsPerHost = dart.privateName(io, "HttpClient.maxConnectionsPerHost");
  const userAgent = dart.privateName(io, "HttpClient.userAgent");
  ...
  const encoding = dart.privateName(io, "HttpClientRequest.encoding");
